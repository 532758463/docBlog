...
![img](img/5d0c3daa00016e6a06400359.jpg)
...
上面例子中，我们通过 addName 修饰符可以在类 A 的原型对象上添加一个 name 属性，这样使用 A 创建的实例，应该可以继承这个 name 属性，访问实例对象的 name 属性应该返回"lison"，<span style="color: red">但是这里报错，是因为我们定义的类 A 并没有定义属性 name</span>，所以我们可以定义一个<span style="color: red">同名接口</span>，通过声明合并解决这个问题：
...
![图片描述](img/5d0346630001d68416000247.jpg)
