...
![img](img/5cf3c48b0001693506400359-1583674927907.jpg)
...
`unknown`类型是TypeScript在3.0版本新增的类型，它表示未知的类型，这样看来它貌似和any很像，但是还是有区别的，也就是所谓的“**unknown相对于any是安全的**”。
...
![图片描述](img/5cf4bf5e0001c4e116001100.jpg)